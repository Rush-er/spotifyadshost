...
echo 0.0.0.0	d2gi7ultltnc2u.cloudfront.net >> %hostspath%
echo 0.0.0.0	d3rt1990lpmkn.cloudfront.net >> %hostspath%
echo 0.0.0.0	desktop.spotify.com >> %hostspath%
echo 0.0.0.0	doubleclick.net >> %hostspath%
echo 0.0.0.0	ds.serving-sys.com >> %hostspath%
echo 0.0.0.0	googleadservices.com >> %hostspath%
echo 0.0.0.0	googleads.g.doubleclick.net >> %hostspath%
echo 0.0.0.0	gtssl2-ocsp.geotrust.com >> %hostspath%
echo 0.0.0.0	js.moatads.com >> %hostspath%
echo 0.0.0.0	log.spotify.com >> %hostspath%
echo 0.0.0.0	media-match.com >> %hostspath%
echo 0.0.0.0	omaze.com >> %hostspath%
echo 0.0.0.0	pagead46.l.doubleclick.net >> %hostspath%
echo 0.0.0.0	pagead2.googlesyndication.com >> %hostspath%
echo 0.0.0.0	partner.googleadservices.com >> %hostspath%
echo 0.0.0.0	pubads.g.doubleclick.net >> %hostspath%
echo 0.0.0.0	redirector.gvt1.com >> %hostspath%
echo 0.0.0.0	s0.2mdn.net >> %hostspath%
echo 0.0.0.0	securepubads.g.doubleclick.net >> %hostspath%
echo 0.0.0.0	spclient.wg.spotify.com >> %hostspath%
echo 0.0.0.0	tpc.googlesyndication.com >> %hostspath%
echo 0.0.0.0	v.jwpcdn.com >> %hostspath%
echo 0.0.0.0	video-ad-stats.googlesyndication.com >> %hostspath%
